...
import { BlogsController } from './entities/blogs/blogs.controller';
...
import { BlogsService } from './entities/blogs/blogs.service';
import { BlogsRepository } from './entities/blogs/infrastructure/blogs.repository';
...
import { Blog, BlogsSchema } from './entities/blogs/schemas/blogs.schema';
import { Post, PostsSchema } from './entities/posts/schemas/post.schema';
import { AuthController } from './entities/auth/auth.controller';
import { AuthService } from './entities/auth/application/auth.service';
...
import { TokenService } from './entities/auth/application/token.service';
...
import { BlogsQueryRepository } from './entities/blogs/infrastructure/blogs.query.repository';
...
@Module({
  imports: [
    ...
    MongooseModule.forFeature([
      { name: Blog.name, schema: BlogsSchema },
